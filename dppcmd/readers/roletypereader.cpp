...
namespace dppcmd
{
    type_reader_result role_in::read(dpp::cluster* cluster, const dpp::message_create_t* context, const std::string& input)
    {
    ...
    void role_in::add_results_by_id(const dpp::snowflake guild_id, const std::string& input)
    {
    ...
    void role_in::add_results_by_mention(const dpp::snowflake guild_id, const std::string& input)
    {
    ...
    void role_in::add_results_by_name(const dpp::snowflake guild_id, const std::string& input)
    {
